...
class GameState:
    ...
    def __init__(self, hero_action, audio_player):
        ...
        self.last_hero_action_log = (
            ""  # Last action of the hero with AI analysis(this is used for GUI display)
        )
    ...
    def extract_blinds_from_title(self):
        ...
        windows = pwc.getWindowsWithTitle(title_contains)
    ...
    def add_log_entry(self, data):
        ...
        # Update Hero Actions
            ...
            try:
                ...
                amount = (
                    0  # Or handle it in a way that makes sense for your application
                )

            if amount > 0:
                final_string = (
                    f"Hero Action: {action} ${amount} \n"
